...
class MySqlParserVisitor(ParseTreeVisitor):
    ...
    def visitEmptyStatement_(self, ctx:MySqlParser.EmptyStatement_Context):
        return self.visitChildren(ctx)
    ...
    def visitCommonTableExpressions(self, ctx:MySqlParser.CommonTableExpressionsContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#cteName.
    def visitCteName(self, ctx:MySqlParser.CteNameContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#cteColumnName.
    def visitCteColumnName(self, ctx:MySqlParser.CteColumnNameContext):
        return self.visitChildren(ctx)
    ...
    def visitCurrentUserExpression(self, ctx:MySqlParser.CurrentUserExpressionContext):
        return self.visitChildren(ctx)
    ...
    def visitInvisibilityColumnConstraint(self, ctx:MySqlParser.InvisibilityColumnConstraintContext):
        return self.visitChildren(ctx)
    ...
    def visitClusteringKeyColumnConstraint(self, ctx:MySqlParser.ClusteringKeyColumnConstraintContext):
        return self.visitChildren(ctx)
    ...
    def visitClusteringKeyTableConstraint(self, ctx:MySqlParser.ClusteringKeyTableConstraintContext):
        return self.visitChildren(ctx)
    ...
    def visitTableOptionEngineAttribute(self, ctx:MySqlParser.TableOptionEngineAttributeContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#tableOptionAutoextendSize.
    def visitTableOptionAutoextendSize(self, ctx:MySqlParser.TableOptionAutoextendSizeContext):
        return self.visitChildren(ctx)
    ...
    def visitTableOptionPageCompressed(self, ctx:MySqlParser.TableOptionPageCompressedContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#tableOptionPageCompressionLevel.
    def visitTableOptionPageCompressionLevel(self, ctx:MySqlParser.TableOptionPageCompressionLevelContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#tableOptionEncryptionKeyId.
    def visitTableOptionEncryptionKeyId(self, ctx:MySqlParser.TableOptionEncryptionKeyIdContext):
        return self.visitChildren(ctx)
    ...
    def visitTableOptionStartTransaction(self, ctx:MySqlParser.TableOptionStartTransactionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#tableOptionSecondaryEngine.
    def visitTableOptionSecondaryEngine(self, ctx:MySqlParser.TableOptionSecondaryEngineContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#tableOptionSecondaryEngineAttribute.
    def visitTableOptionSecondaryEngineAttribute(self, ctx:MySqlParser.TableOptionSecondaryEngineAttributeContext):
        return self.visitChildren(ctx)
    ...
    def visitTableOptionTransactional(self, ctx:MySqlParser.TableOptionTransactionalContext):
        return self.visitChildren(ctx)
    ...
    def visitAlterByAlterCheckTableConstraint(self, ctx:MySqlParser.AlterByAlterCheckTableConstraintContext):
        return self.visitChildren(ctx)
    ...
    def visitAlterByAlterColumnDefault(self, ctx:MySqlParser.AlterByAlterColumnDefaultContext):
        return self.visitChildren(ctx)
    ...
    def visitAlterByAddDefinitions(self, ctx:MySqlParser.AlterByAddDefinitionsContext):
        return self.visitChildren(ctx)
    ...
    def visitSetRole(self, ctx:MySqlParser.SetRoleContext):
        return self.visitChildren(ctx)
    ...
    def visitWithLateralStatement(self, ctx:MySqlParser.WithLateralStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitValuesStatement(self, ctx:MySqlParser.ValuesStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitTableJson(self, ctx:MySqlParser.TableJsonContext):
        return self.visitChildren(ctx)
    ...
    def visitSequenceTableItem(self, ctx:MySqlParser.SequenceTableItemContext):
        return self.visitChildren(ctx)
    ...
    def visitJoinSpec(self, ctx:MySqlParser.JoinSpecContext):
        return self.visitChildren(ctx)
    ...
    def visitLateralStatement(self, ctx:MySqlParser.LateralStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#jsonTable.
    def visitJsonTable(self, ctx:MySqlParser.JsonTableContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#jsonColumnList.
    def visitJsonColumnList(self, ctx:MySqlParser.JsonColumnListContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#jsonColumn.
    def visitJsonColumn(self, ctx:MySqlParser.JsonColumnContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#jsonOnEmpty.
    def visitJsonOnEmpty(self, ctx:MySqlParser.JsonOnEmptyContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#jsonOnError.
    def visitJsonOnError(self, ctx:MySqlParser.JsonOnErrorContext):
        return self.visitChildren(ctx)
    ...
    def visitAlterUserMysqlV80(self, ctx:MySqlParser.AlterUserMysqlV80Context):
        return self.visitChildren(ctx)
    ...
    def visitCreateUserMysqlV80(self, ctx:MySqlParser.CreateUserMysqlV80Context):
        return self.visitChildren(ctx)
    ...
    def visitRoleOption(self, ctx:MySqlParser.RoleOptionContext):
        return self.visitChildren(ctx)
    ...
    def visitRandomAuthOption(self, ctx:MySqlParser.RandomAuthOptionContext):
        return self.visitChildren(ctx)
    ...
    def visitModuleAuthOption(self, ctx:MySqlParser.ModuleAuthOptionContext):
        return self.visitChildren(ctx)
    ...
    def visitAuthOptionClause(self, ctx:MySqlParser.AuthOptionClauseContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#module.
    def visitModule(self, ctx:MySqlParser.ModuleContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#passwordModuleOption.
    def visitPasswordModuleOption(self, ctx:MySqlParser.PasswordModuleOptionContext):
        return self.visitChildren(ctx)
    ...
    def visitWithStatement(self, ctx:MySqlParser.WithStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#tableStatement.
    def visitTableStatement(self, ctx:MySqlParser.TableStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitRoleName(self, ctx:MySqlParser.RoleNameContext):
        return self.visitChildren(ctx)
    ...
    def visitSimpleUserName(self, ctx:MySqlParser.SimpleUserNameContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#hostName.
    def visitHostName(self, ctx:MySqlParser.HostNameContext):
        return self.visitChildren(ctx)
    ...
    def visitEngineNameBase(self, ctx:MySqlParser.EngineNameBaseContext):
        return self.visitChildren(ctx)
    ...
    def visitCollectionOption(self, ctx:MySqlParser.CollectionOptionContext):
        return self.visitChildren(ctx)
    ...
    def visitFullColumnNameList(self, ctx:MySqlParser.FullColumnNameListContext):
        return self.visitChildren(ctx)
    ...
    def visitOrReplace(self, ctx:MySqlParser.OrReplaceContext):
        return self.visitChildren(ctx)
    ...
    def visitNonAggregateFunctionCall(self, ctx:MySqlParser.NonAggregateFunctionCallContext):
        return self.visitChildren(ctx)
    ...
    def visitCurrentUser(self, ctx:MySqlParser.CurrentUserContext):
        return self.visitChildren(ctx)
    ...
    def visitNonAggregateWindowedFunction(self, ctx:MySqlParser.NonAggregateWindowedFunctionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#overClause.
    def visitOverClause(self, ctx:MySqlParser.OverClauseContext):
        return self.visitChildren(ctx)
    ...
    def visitFrameClause(self, ctx:MySqlParser.FrameClauseContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#frameUnits.
    def visitFrameUnits(self, ctx:MySqlParser.FrameUnitsContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#frameExtent.
    def visitFrameExtent(self, ctx:MySqlParser.FrameExtentContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#frameBetween.
    def visitFrameBetween(self, ctx:MySqlParser.FrameBetweenContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#frameRange.
    def visitFrameRange(self, ctx:MySqlParser.FrameRangeContext):
        return self.visitChildren(ctx)
    ...
    def visitSequenceFunctionName(self, ctx:MySqlParser.SequenceFunctionNameContext):
        return self.visitChildren(ctx)
    ...
    def visitVariableAssignExpressionAtom(self, ctx:MySqlParser.VariableAssignExpressionAtomContext):
        return self.visitChildren(ctx)
    ...
    def visitMultOperator(self, ctx:MySqlParser.MultOperatorContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MySqlParser#addOperator.
    def visitAddOperator(self, ctx:MySqlParser.AddOperatorContext):
        return self.visitChildren(ctx)
